...
//     const limit = Math.max(1, Math.min(100, parseInt(req.query.limit) || 4)); // Limit between 1 and 100
...
//       if (!existingSale) {
//         // Calculate coupon discount based on couponApplied and couponCode
...
//     // Credit wallet with finalAmount
